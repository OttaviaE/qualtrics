...
ggplot(d.item, 
       aes(x = values, fill = new.var, y = prop)) + geom_bar(stat = "identity", position = position_dodge()) + facet_wrap(~type) + scale_y_continuous(breaks=c(0,.25,.50, .75, 1.00),
                       limits = c(0,1.0)) +
    labs(
         y = "Proporzione", 
         x = "Distrattori")+
...
ggplot(d.err, 
       aes(x = Var2, fill = new.var, y = prop)) + geom_bar(stat = "identity", position = position_dodge()) + facet_wrap(~type) + scale_y_continuous(breaks=c(0,.25,.50, .75, 1.00),
                       limits = c(0,1.0)) +
    labs(
         y = "Proporzione", 
         x = "Distrattori")+
