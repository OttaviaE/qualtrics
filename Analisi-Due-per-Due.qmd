...
Sull'asse delle y sono riporate le matrici ordinate dalla più difficile (bottom) alla più facile (top), sull'asse delle x sono riportati i tempi ad ogni matrice. I bambini prescoalri (yy) sono riportati in rosa, quelli scoalri (Y) sono riporati in azzurro mentre i diversi simboli identificano le coppie di matrici. Le etichette delle matrici riportate in grassetto indicano che la matrice in questione è colorata. 
